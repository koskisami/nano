...
module.exports = {
  ...
  async execute(interaction) {
    await interaction.reply(
      "**ℹ️ Fun fact: ** You are seeing this because the command occasionally takes more than 3 seconds to execute, and Discord API does not like that."
    );
    let apiURL;
    let fullURL;
    ...
    try {
      ...
      zoneFirstWord =
        zoneFirstWord.charAt(0).toUpperCase() + zoneFirstWord.slice(1);
